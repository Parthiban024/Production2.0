...
app.post('/api/timechamp', (req, res) => {
  const { employeeNameTwo, employeeIdTwo, emailIdTwo, systemNoTwo, systemTypeTwo, unitNoTwo, floorNoTwo, teamNameTwo, teamManagerTwo, priorityTwo, issueDateTwo, descriptionTwo, timeTaken } = req.body;

  const newReviewTwo = new ReviewTwo({
    employeeNameTwo, employeeIdTwo, emailIdTwo, systemNoTwo, systemTypeTwo, unitNoTwo, floorNoTwo, teamNameTwo, teamManagerTwo, priorityTwo, issueDateTwo, descriptionTwo, timeTaken
  });
